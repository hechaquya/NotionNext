const CONFIG = {
  ...
  HEO_NOTICE_BAR: [
    { title: '欢迎来到赵老师的网站', url: 'https://zhaolaoshi.fun' },
    { title: '日拱一卒，功不唐捐', url: 'https://zhaolaoshi.fun' }
  ],
  ...
  HEO_INFO_CARD_URL3: 'https://zhaolaoshi.fun/about',//这里是了解更多跳转的链接
